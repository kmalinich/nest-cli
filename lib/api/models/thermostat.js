...
class Thermostat extends Model {
	static attrs() {
		...
		return {
			...
			lockedTemperatureMaxC : attr('number', { alias : 'locked_temp_max_c', readOnly : true }),
			lockedTemperatureMaxF : attr('number', { alias : 'locked_temp_max_f', readOnly : true }),
			lockedTemperatureMinC : attr('number', { alias : 'locked_temp_min_c', readOnly : true }),
			lockedTemperatureMinF : attr('number', { alias : 'locked_temp_min_f', readOnly : true }),
